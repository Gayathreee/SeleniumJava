...
public class ActionsAssignment {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * https://jqueryui.com/draggable https://jqueryui.com/droppable
		 * https://jqueryui.com/resizable https://jqueryui.com/selectable
		...
		Actions actions = new Actions(driver); 
		 ...
		 driver.switchTo().frame(0);
		  ...
		  driver.switchTo().frame(0); WebElement findElement1 =
		  driver.findElement(By.id("draggable")); System.out.println(findElement);
		  System.out.println(findElement1); WebElement findElement2 =
		  driver.findElement(By.id("droppable")); actions.dragAndDrop(findElement1,
		  findElement2).perform(); driver.switchTo().parentFrame();
